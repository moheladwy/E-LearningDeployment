...
async function fetchEnrollments(token: string) {
	...
	const URL =
		"http://courses-service:8080/learning/enrollment/instructor-list/";
...
const handleAccept = async (enrollmentId: number) => {
	...
	const URL = "http://courses-service:8080/learning/enrollment/accept/";
...
const handleReject = async (enrollmentId: number) => {
	...
	const URL = "http://courses-service:8080/learning/enrollment/reject/";
